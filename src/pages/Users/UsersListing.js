...
import TableNoRecordFound from '../../component/Table/TableNoRecordFound';
import ModeEditOutlineIcon from '@mui/icons-material/ModeEditOutline';
import DeleteIcon from '@mui/icons-material/Delete';
import { useDispatch, useSelector } from 'react-redux';
import ConfirmationModal from '../../component/Modal/ConfirmationModal';
import { TIMEOUT_TIME } from '../../Utilis/Utilis';
import { deleteUsers, resetUsers } from '../../redux/Users/Users.action';
import { rolelist } from '../../component/MainData/Data';
...
const UserListing = () => {
    ...
    const userList = useSelector((state) => state.users.usersData)
    const handleDelete = () => {
        dispatch(deleteUsers(openModal))
    }
