...
import { createUsers, resetUsers, singleUsers, updatedUsers } from '../../redux/Users/Users.action';
...
const UserForm = () => {
  ...
  const { message, userDetails } = useSelector((state) => {
    return {
